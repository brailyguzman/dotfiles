...
export BAR_COLOR=0xff181820     # Your Ghostty background
export ITEM_BG_COLOR=0xff2a2a37 # Kanagawa sumiInk1 (darker item bg)
export ACCENT_COLOR=0xff7e9cd8  # Kanagawa springBlue (bright & vibrant)
